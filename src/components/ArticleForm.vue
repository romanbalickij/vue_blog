      ...
      <div class="container page">
          <div class="row">
            <div class="col-md-10 offset-md-1 col-xs-12">
               <McvValidationErrors v-if="errors" :validation-errors="errors"></McvValidationErrors>
               <form @submit.prevent="onSubmit">
                <fieldset>
                  ...
                  <fieldset class="form-group">
                    <input type="text" class="form-control form-control-lg" placeholder="Enter tag" v-model="tagList">
                  </fieldset>
                  <fieldset class="form-group">
